...
function CGnssView(hParent){
    ...
    let option = {
            ...
            aChildViews: [],
            aEvCallback: {},//{evActived: function(){console.log('CGnssView::evActived')},},
        };
...
CGnssView.prototype.regCtrlCb = function(){
...
CGnssView.prototype.getDatafromServer = function(){
    let str = {
