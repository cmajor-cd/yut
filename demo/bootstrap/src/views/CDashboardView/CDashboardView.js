...
class CDashboardView extends CView{
    constructor(hParent){
        ...
        // 多语言实现
        _this.enHtmlMap = {
            // dsvSysDemoTitleTxt:"Create childView + Html/Js sync",dsvSysTitleTxt: "System Status", dsvLocTimeTxt: "Local Time", dsvDurationTimeTxt:"Duration Time",dsvIMEITxt: "IMEI",dsvFWVerTxt:"Firmware Ver.",
        ...
        _this.cnHtmlMap = {
            // dsvSysDemoTitleTxt:"演示childView创建 + Html/Js数据同步",dsvSysTitleTxt:"系统状态",dsvLocTimeTxt:"本机时间",dsvDurationTimeTxt:"本次开机持续时间",dsvIMEITxt:"硬件设备号",dsvFWVerTxt:"固件版本号",
